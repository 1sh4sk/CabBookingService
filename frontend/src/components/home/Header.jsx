...
const Header = () => {
  ...
  return (
    <div className="relative min-h-screen w-full">
      ...
      >
        {/* Header Section */}
        <header className="bg-white shadow-md py-1 px-4 sm:px-6 md:px-8 flex items-center justify-between absolute top-3 left-1/2 transform -translate-x-1/2 w-11/12 sm:w-5/6 md:w-4/5 z-50 rounded-full">
          ...
          {/* Desktop Navigation */}
          <nav className="hidden lg:flex space-x-8">
            <a href="#" className="text-gray-800 hover:text-yellow-500 font-medium transition duration-300">Home</a>
            <a href="#" className="text-gray-800 hover:text-yellow-500 font-medium transition duration-300">Why Choose Us</a>
            <a href="#" className="text-gray-800 hover:text-yellow-500 font-medium transition duration-300">Rent</a>
            <a href="#" className="text-gray-800 hover:text-yellow-500 font-medium transition duration-300">About Us</a>
          </nav>

          {/* Right Side - Buttons */}
          <div className="hidden lg:flex items-center space-x-4">
            <Link to="/login">
              <button className="text-gray-700 font-medium px-4 md:px-6 py-1 md:py-2 border-2 border-yellow-500 hover:bg-yellow-500 hover:text-black transition duration-300 rounded-full">
                Login
              </button>
            </Link>
            <Link to="/register">
              <button className="bg-yellow-500 text-black px-4 md:px-6 py-1 md:py-2 border-2 border-yellow-500 rounded-full font-medium hover:bg-white hover:text-gray-600 transition duration-300">
                Register
              </button>
            </Link>
          </div>
...
{isOpen && (
  <div className="lg:hidden absolute top-25 sm:top-15 left-0 w-full bg-white shadow-md z-50 
      transition-transform duration-300 ease-in-out transform scale-y-100 opacity-100 origin-top">
    ...
    <nav className="flex flex-col space-y-4 p-4">
      ...
      <Link to="/login" className="w-full flex justify-center">
        <button className="text-gray-700 w-3/4 sm:w-1/2 text-center font-medium px-4 py-2 border-2 border-yellow-500 hover:bg-yellow-500 hover:text-black transition duration-300 rounded-full">
          Login
        </button>
      </Link>
      <Link to="/register" className="w-full flex justify-center">
        <button className="bg-yellow-500 w-3/4 sm:w-1/2 text-center text-black px-4 py-2 border-2 border-yellow-500 rounded-full font-medium hover:bg-white hover:text-gray-600 transition duration-300">
          Register
        </button>
      </Link>
    </nav>
