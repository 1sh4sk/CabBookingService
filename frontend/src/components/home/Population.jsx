...
const Population = () => {
  return (
    <div id="services" className="relative min-h-screen p-5 md:p-10">
      ...
      <div className="relative z-10  min-h-screen">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 xl:mx-15">

          {/* Row 1 */}
          <div className="p-4">
            <h1 className="text-2xl md:text-[25px] font-bold font-epilogue mb-2">Our Popular Services</h1>
            <h6 className="text-gray-600 text-base xl:text-lg">
