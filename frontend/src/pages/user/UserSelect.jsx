          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="mt-6 mb-10">
              ...
              <div className="ml-60 mr-5">
                <h6 className="font-bold">Confirm your Ride</h6>
              ...
              <br/>
              <div className='flex items-center justify-center ml-70 mr-20 mt-4 '>
                <button type='button' className='w-full p-2 rounded mt-1 mb-4 font-bold bg-green-500 text-white '>
                    Request a ride
                </button>
              </div>
            </div>
