...
//   Already have an account? <a href="/captain-login" className="text-yellow-600 font-semibold hover:underline">Sign in here</a>
// </p>
...
//           <img src={"../src/component/Captain_bg.png"} alt="Register" className="w-full h-full object-cover" />
